...
int main( int argc, char** argv )
{
    ...
    for ( int i = 0; i < dims[0]; ++i )
    {
        ...
        {
            MPI_Win_fence( 0, aBlockWin );
            checkres( MPI_Get( tempBufABlock.raw(), 1, SR_ABLOCK, ( i + coords[0] ) % sqrtProcNum, 0, 1, SR_ABLOCK, aBlockWin ) );
            MPI_Win_fence( 0, aBlockWin );
            workingBlock = tempBufABlock;
        }
        ...
        checkres( sendRecvReplace( bBlockWin, tempBufBBlock, bBlock, SR_BBLOCK, upRank ) );
    }
